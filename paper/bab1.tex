...
% //TODO: amandemen -> amendemen
% //TODO: format UU X/YYYY
...
\Legal adalah peraturan tertulis yang memuat norma hukum yang mengikat secara
umum dan dibentuk atau ditetapkan oleh lembaga negara atau pejabat yang berwenang melalui prosedur
yang ditetapkan dalam \legal, sesuai yang dijelaskan dalam Undang-Undang
...
aplikasi tersebut dalam skala lebih besar dan biaya lebih murah, jika \legal
...
dokumen yang bersifat semi-terstruktur, \legal dapat diubah menjadi KG.
...
konstruksi KG dari beberapa berkas PDF \legal dan \textit{query} pada KG
tersebut. Pada skripsi ini, akan dilakukan konversi dokumen \legal menjadi
...
\legal di Indonesia. Sehingga dengan membuat \textit{vocabulary} untuk
struktur data dan \legal di Indonesia, diharapkan dapat menjadi kontribusi
dalam mendukung pembuatan KG untuk dokumen \legal.
...
automasi konversi dokumen \legal menjadi KG secara
...
\begin{itemize}
  ...
  \item Bagaimana evaluasi use case terhadap kg \legal tersebut serta evaluasi
...
% // TODO: karena hrs cek manual
  \item Tidak dapat melakukan \textit{query} terhadap KG yang kompleks (contoh: ``Jika saya berusia 12 tahun,
...
\textit{query} untuk diperiksa apakah KG mengembalikan jawaban yang sesuai. Kemudian, dirancang ontologi
...
Karena sulit untuk menjamin hasil konversi untuk semua PDF \legal, akan
