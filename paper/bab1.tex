...
akan dijamin konversinya benar yang selanjutnya akan disebut \textit{maintained PDFs}. Pengembangan
sistem konversi dilakukan secara iteratif. Setiap terdapat perubahan pada sistem, akan dicek apakah
untuk semua \textit{maintained PDFs} memberikan hasil konversi yang benar. Sistem konversi akan
