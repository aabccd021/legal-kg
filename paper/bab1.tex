...
yang dapat diolah oleh komputer. Akan tetapi, data \legal umumnya dibuat dalam bentuk
...
teks bahasa manusia (natural language) yang tak terstruktur (unstructured).
...
dokumen yang bersifat semi-terstruktur, \legal dapat diubah menjadi KG. Sebagai manfaatnya, dapat
fitur-fitur berbasis \textit{query} seperti \textit{question answering}, \textit{reasoning} dan
visualisasi data. \pic~\ref{fig:konstruksi-dan-query} menampilkan proses konstruksi KG dari beberapa
berkas PDF \legal dan \textit{query} pada KG tersebut. Pada skripsi ini, akan dilakukan konversi
dokumen \legal menjadi data terstruktur dalam bentuk KG, dan memberikan contoh aplikasi dari KG
\legal tersebut. Beberapa usaha telah dilakukan untuk membuat \textit{vocabulary} untuk KG \legal
