...
Perwakilan Rakyat pada situs web \url{https://dpr.go.id/jdih}, masing-masing dokumen dibuat kedalam
...
- xL: 257.28
  ...
  id: 3
  \end{minted}
  \caption{Hasil pemindaian \pic~\ref{fig:contoh-dokumen}}
...
triple. Jumlah tripel dikelompokan berdasarkan jenis informasi dapat dilihat pada
...
\begin{table}
  ...
  \end{tabular}
  \caption{Analisis triple KG hasil konversi skala besar}
