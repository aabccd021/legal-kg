...
bab ini. Seluruh program dan \textit{resource} tersedia pada repositori lex2kg
\footnote{\url{https://github.com/aabccd021/legal-kg}}.
...
% // HACK: Benerin istilah section nya
...
% // TODO: uu cipta kerj
% // TODO: competency question: dilampiran, ditangani, dikasih disini representatif, kasih judul gan
% // TODO: panah menimbang
% // TODO: penulis membuat versi poster paper, status menunggu review. versi paper.
%--------------------------------------------------------------------------------------------------%
...
Sebagai contoh, jika terdapat triple \mono{uu:2020/11/bab o:bab uu:2020/11/bab/1}, \textit{reverse
triple} nya adalah \mono{uu:2020/11/bab/1 o:bab uu:2020/11/bab}. Properti struktur antaralain adalah
\mono{o:ayat}, \mono{o:bab}, \mono{o:bagian}, \mono{o:daftarAyat}, \mono{o:daftarBab},
\mono{o:daftarBagian}, \mono{o:daftarHuruf}, \mono{o:daftarParagraf}, \mono{o:daftarPasal},
\mono{o:huruf}, \mono{o:paragraf}, \mono{o:pasal}, \mono{o:segmen}, \mono{o:teks}, dan
\mono{o:versi}.
