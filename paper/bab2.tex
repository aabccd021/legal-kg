...
adalah \mono{https://example.org/james}, \mono{https://example.org/has\_visited},
...
\mono{https://example.org/has\_name}, "james". \mono{https://example.org/james},
\mono{https://example.org/louvre} berturut-turut merupakan notasi untuk \textit{resource} entitas
james dan Louvre, \mono{https://example.org/has\_visited} dan \mono{https://example.org/has\_name}
...
titik koma. \lst~\ref{lst:contoh-singkat-ttl} adalah contoh penulisan dua \textit{triple} diatas
...
contohnya sebuah variabel diawali dengan tanda tanya seperti \mono{?name}. Berikut adalah
...
\begin{table}
  ...
  \begin{tabular}{|l|l|l|} \hline
    ...
    \texttt{ex:james} & \texttt{ex:has\_name}    & "james"            \\\hline
  \end{tabular}
