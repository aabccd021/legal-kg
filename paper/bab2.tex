...
% //HACK: bs dilengkapin lg, fitur2nya sparql apa aja
% //HACK: query 1 simpel gpp
% //HACK: query 2 yg bbrp triple patterns
% //HACK: query 3 yg agak kompleks, msl pke aggregates, atau negation dsb
...
% // HACK: jelasin ya, bs pke screenshot
