...
% // TODO: Perlu dijelasin Lex2KG mengandung PDF2KG dan PDF2KG mengandung Span2KG.

Jgn lp jg dijelasin step2nya yg ada di arsitektur/diagram tsb
Proses konversi dokumen PDF ke KG mengikuti arsitektur seperti yang ditunjukkan pada
\pic~\ref{fig:pdf2kg} dan \pic~\ref{fig:span2kg}. Bagian \textit{Optical Character Recognition}
(OCR) bertanggung jawab untuk mengubah \textit{image-only} PDF menjadi \textit{text-scannable} PDF
dan menstandardisasi pemformatan semua PDF. Selanjutnya, penulis melakukan pemindaian file PDF untuk
mengekstrak teks beserta posisinya. Selanjutnya, setiap baris teks yang dipindai sebagai
\textit{span}. Setelah itu, \textit{span} yang terdeteksi sebagai konten yang tidak relevan, seperti
\textit{header} dan \textit{footer} yang berulang, akan disaring. \textit{Clean span} yang
dihasilkan, kemudian diuraikan menjadi data \legal yang bermakna dan terstruktur. Pada tahap akhir,
sistem konversi membangun KG \legal dari hasil \textit{parsing}. Setiap KG \legal dihasilkan dari
PDF akan digabung menjadi satu KG global.
...
% // TODO:Mesti dikasih kyk konteksnya itu yg tabel2 di atas.
% // TODO:Nanti jk ditambah gambar lg, perlu dikasih pengantar
% // TODO: Yg amendemen dan segmen bs dikasih, cm gak hrs lgkap bgt bs kyk subset/snippet
