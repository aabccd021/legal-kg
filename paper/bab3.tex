...
Untuk memahami ontologi secara intuitif, ontologi dapat divisualisasikan.
\pic~\ref{fig:ontologi-struktur} adalah ontologi struktur data peraturan yaitu komponen-komponen
peraturan serta properti yang menghubungkannya dan metadata yang terdapat pada peraturan.

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.3]{pictures/ontologi-stuktur.png}
  \caption{Ontologi struktur dan metadata peraturan}
  \label{fig:ontologi-struktur}
\end{figure}

% // HACK: ilustrasi amendemen