...
% // TODO: Kasih judul ``Query tentang Amendemen UU Cipta Kerja''
% // TODO: Dijelasin jg fitur querynya

\textit{Competency question} No. 10 ``Tampilkan banyaknya penyisipan, pengubahan, dan penghapusan
pasal yang dilakukan UU Cipta Kerja terhadap UU lain.'' dapat dijawab dengan melakukan \textit{query}
...
% // TODO: tmbhkn satu skenario yg smpai liat konten
...
terhadap KG menggunakan template \lst~\ref{lst:chatbot-2-query}, di mana \mono{legalURI} memiliki
...
melakukan \textit{query} terhadap KG menggunakan template \lst~\ref{lst:chatbot-3-query}, di mana
